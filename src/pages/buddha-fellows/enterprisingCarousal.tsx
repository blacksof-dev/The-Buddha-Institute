...
export default function EnterprisingSwiper() {
  ...
  return (
    <div className=" swipercontainer">
      <Swiper
        ...
        className=" sm:pl-[8%] !mt-6 lg:!pl-[6%] 2xl:!pl-[8%]  !pl-3 !pr-3 xlg:!mt-14  relative"
        ...
        {apidata.map((card, index) => (
          <SwiperSlide key={index}>
            <div className="mx-auto grid lg:grid-cols-2   h-[45rem] w-full flex-col sm:mx-0 sm:h-[60rem]  md:h-[30rem] xlg:h-[34rem]">
              ...
              <div
                className={` h-[18rem] sm:h-[20rem] md:h-full ${
                  index % 2 === 0 ? "bg-[#D6DF20]" : "bg-[#39B54A]"
                } relative sm:pb-6 pt-4 `}
              >
