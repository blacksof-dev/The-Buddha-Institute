...
const Newsletter = ({title}:{title:string}) => {
  ...
  return (
    <section className="blade-top-padding sm:blade-top-padding-sm w-container-xl ">
      <div className=" ">
        <div className=" ">
          <h1 className="font-lato-bold  md:pb-0 text-[#07393C]">{title}</h1>
...
const fellowshipdata = {
  productArray: [
    {
      image: "/Resources/BrouchersImg2.jpg",
      id: "1",
      title: "The Buddha Fellowship Program",
      desc1: "An overview of the Essentials",
      link: "/Resources/broucher_01.pdf",
    },
    {
      image: "/Resources/BrouchersImg1.png",
      id: "2",
      title: "Empowering Development Entrepreneurs",
      desc1: "Our purpose and impact in a nutshell",
      link: "/Resources/broucher_02.pdf",
    },
  ],
};
