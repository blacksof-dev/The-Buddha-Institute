...
export default function FrequentlyAsked() {
  return (
    <>
      <section className="blade-bottom-padding-lg blade-top-padding bg-[#FAF9F5] gsap-fade-in">
        <div className="w-container-xl">
          ...
          <div className="lg:flex gap-x-12 ">
            <div className="w-[40%] sm:w-[20%] lg:ml-0 ml-2 lg:max-w-[30%] md:max-w-[50%] blade-top-padding-sm">
              <h3 className=" text-[#07393C] bg-pear hover:bg-teal hover:text-white transition-all duration-500 cursor-pointer sm:py-4 py-2 mr-2 px-4 font-lato-regular">
                FAQs
              </h3>
            </div>
