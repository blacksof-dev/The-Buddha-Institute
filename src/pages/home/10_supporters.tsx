      ...
      <section className="blade-top-padding-lg blade-bottom-padding-lg bg-[#FAF9F5]">
        ...
        <div className="">
          ...
          <div className="align center mb-6 justify-center gap-4 lg:flex sm:gap-9 xl:gap-10 2xl:gap-14">
            <button
              className={` d sm:px-6 px-2 flex gap-2 2xl:text-xl font-lato-regular sm:py-4 py-2 border border-gray-200  rounded-full lg:mx-0 mx-auto d ${activeSection === "section1"
          ...
          >
            ...
            {activeSection === "section3" && (
              <div className=" mt-0  gap-x-2 sm:flex sm:gap-6 flex items-center flex-col justify-center">
