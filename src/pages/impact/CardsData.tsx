...
const FellowShip = () => {
  ...
  return (
    <>
      <section className=" bg-[#FAF9F5] px-4 ">
        <div className=" cursor-pointer relative blade-top-padding-sm blade-bottom-padding-sm lg:pt-14 gsap-fade-in">
          <Swiper
            modules={[Pagination, Navigation]}
            className="  md:!ps-[5%] lg:!ps-[5%]  xl:!pl-[7%] 2xl:!pl-[8%] 3xl:!pl-[8%]"
            spaceBetween={20}
            slidesPerView={1.1}
