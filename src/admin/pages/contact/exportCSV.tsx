...
const ExportCSV: React.FC = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_LOCAL_URL}/api/contact/show`);
    ...
    const exportToCSV = () => {
        if (!data) return;
            ...
            toast.error('No contact emails found to export.', {
                position: "top-right",
                autoClose: 3000,
    ...
    return (
        <div className=" w-fit  ">
            ...
            {/* <span className="font-lato-regular text-sm  leading-none w-[14rem] inline-block mt-2">NOTE: Click the button below to fetch all  user data and export it as a CSV file.</span> */}
